"""
Tier10 Dataset Loader - Kimi Noise Ablation

Loads the tier10 dataset (kimi noise ablation data).
...
@register_dataset("tier10")
class Tier10Dataset(BaseDataset):
    """Dataset loader for tier10 (kimi noise ablation)."""
    ...
    def load(self) -> None:
        ...
        logger.info(f"Loading Tier10 dataset from {self.data_dir}")
