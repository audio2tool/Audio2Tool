"""
Tier9 Dataset Loader - Gemma3 Noise Ablation

Loads the tier9 dataset (gemma3 noise ablation data).
...
@register_dataset("tier9")
class Tier9Dataset(BaseDataset):
    """Dataset loader for tier9 (gemma3 noise ablation)."""
    ...
    def load(self) -> None:
        ...
        logger.info(f"Loading Tier9 dataset from {self.data_dir}")
